 ...
 * {@link ArtistFragment.ArtistInteractionListener} interface
...
public class ArtistFragment extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onArtistInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ArtistInteractionListener) {
            mListener = (ArtistInteractionListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement ArtistInteractionListener");
        }
    }
