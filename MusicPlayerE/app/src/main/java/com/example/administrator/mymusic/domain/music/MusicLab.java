...
import static com.example.administrator.mymusic.Util.Const.Category.ALBUM;
import static com.example.administrator.mymusic.Util.Const.Category.ARTIST;
import static com.example.administrator.mymusic.Util.Const.Category.FOLDER;
...
public class MusicLab {
    ...
    public List<Music> loadData(int category, String identifier) {

        // todo 이거 동기화 할 때 문제 생긴다. 미리 생성해 둬야 함.
        ...
        switch(category){
            case ALBUM:
                ...
                break;
            case ARTIST:
                whereClause = MediaStore.Audio.Media.ARTIST + " = ?";
                break;
            case FOLDER:
