...
//        pagerItemName = (TextView) view.findViewById(R.id.pagerItemName);
//        pagerItemArtist = (TextView) view.findViewById(R.id.pagerItemArtist);
        pageItemImage = (ImageView) view.findViewById(R.id.pageItemImage);
//
//        pagerItemName.setText(song.title);
//        pagerItemArtist.setText(song.artist);
