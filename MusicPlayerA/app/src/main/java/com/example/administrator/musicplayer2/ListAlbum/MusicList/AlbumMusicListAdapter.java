...
public class AlbumMusicListAdapter extends RecyclerView.Adapter<AlbumMusicListAdapter.MusicHolder> {
    ...
    // 생성자
    public AlbumMusicListAdapter(List<Item> datas, OnListFragmentInteraction mListener/*, OnListFragmentInter mListInter*/) {
...
//        String listTitle, albumUri;
        ...
        public void setViews(View itemView){
            ...
            albumTitle = (TextView) itemView.findViewById(R.id.albumListAlbum);
            no = (TextView) itemView.findViewById(R.id.albumListno);
        }
        ...
        View.OnClickListener itemListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                goDetail(position, albumListTitle);
